...
- audit logging after sensitive actions (with new REST endpoints added to query audit trails globally for superadmins, or scoped by company for tenant admins/HRs)
